  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <h3
          className="text-white text-xl font-light mb-3 leading-tight"
        ...
        {/* Mini specs */}
        <div
          className="flex gap-4 text-xs text-white/55 pb-5"
...
function EmptyState({ filter }) {
  const messages = {
    ...
    available: {
      title: "Боломжтой байр алга",
      body: "Бүх байр түрээслэгдсэн байна.",
    },
    rented: {
      title: "Түрээслэгдсэн байр алга",
      body: "Танай байрууд хараахан түрээслэгдээгүй байна.",
    },
  };
